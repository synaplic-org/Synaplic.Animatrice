...
using Synaplic.Inventory.Shared.Constants.Storage;
...
namespace Synaplic.Inventory.Client.Pages.Identity
{
    public partial class Profile
    {
        ...
        private async Task LoadDataAsync()
        {
            ...
            _isMobile = (user.GetUserType() == UserType.Mobile.ToString());
        ...
        private async Task DeleteAsync()
        {
            ...
            {
                {nameof(Shared.Dialogs.DeleteConfirmationDialog.ContentText), $"{string.Format(Localizer["Do you want to delete the profile picture of {0}"], _profileModel.Email)}?"}
            };
