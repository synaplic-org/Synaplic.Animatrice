...
using AutoMapper;
using Synaplic.Inventory.Shared.Exceptions;
using Synaplic.Inventory.Application.Extensions;
...
using Synaplic.Inventory.Infrastructure.Specifications;
...
namespace Synaplic.Inventory.Infrastructure.Services.Identity
{
