...
namespace Synaplic.Inventory.Infrastructure.ByDesign.Logistics.Inbound
{
    ...
    {
        [XmlElement(ElementName = "SerialID")]
    ...
    public class MaterialOutput
    {
        ...
        public ActualQuantity ActualQuantity { get; set; }
    ...
    public class SiteLogisticsTask
    {
    ...
    public class SiteLogisticsTaskBundleMaintainRequest_sync_V1
    {
        [XmlElement(ElementName = "BasicMessageHeader")]
        public BasicMessageHeader BasicMessageHeader { get; set; }
        [XmlElement(ElementName = "SiteLogisticsTask")]
        public List<SiteLogisticsTask> SiteLogisticsTask { get; set; }
    ...
    public class Body
    {
        [XmlElement(ElementName = "SiteLogisticsTaskBundleMaintainRequest_sync_V1", Namespace = "http://sap.com/xi/SAPGlobal20/Global")]
        public SiteLogisticsTaskBundleMaintainRequest_sync_V1 SiteLogisticsTaskBundleMaintainRequest_sync_V1 { get; set; }
    }
