...
using Synaplic.Inventory.Client.Infrastructure.Settings;
using MudBlazor;
...
using Synaplic.Inventory.Shared.Managers;
using Synaplic.Inventory.Shared.Constants.Localization;

namespace Synaplic.Inventory.Client.Infrastructure.Managers.Preferences
{
